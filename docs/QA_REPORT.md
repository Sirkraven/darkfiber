...
| 1.5 | Re-derivar `13.6+0.001833·aperture_m` desde las piezas reales de `inject_and_verify_sized` | **CONFIRMADO CORRECTO**, no un hallazgo | `test_noise_floor_constants_rederived_from_real_code` |
